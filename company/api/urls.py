...
orders_router = routers.NestedSimpleRouter(company_router, r'company', lookup='company')
orders_router.register(r'orders', ApiViews.OrderViewSet, basename='company-order')
